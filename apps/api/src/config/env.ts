...
const envSchema = z.object({
  ...
  // The public URL of the frontend application. Used for generating links (e.g., email verification).
  ...
  SEED_ADMIN_GIVEN_NAME: z.string().min(1).optional(),
  SEED_ADMIN_FAMILY_NAME: z.string().min(1).optional(),
});
